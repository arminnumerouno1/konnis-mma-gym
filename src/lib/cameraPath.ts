...
export const CAMERA_KEYS: CamKey[] = [
  ...
  { t: 0.2, position: [0.25, 1.35, -6.2], target: [-2.45, 1.12, -17.35], fov: 36 },
...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.76, position: [0, 1.42, -76.5], target: [0, 0.95, -94], fov: 42 },
  { t: 0.82, position: [0, 1.48, -80.2], target: [0, 0.95, -94], fov: 40 },
  { t: 0.855, position: [0, 1.45, -84.6], target: [0, 0.92, -94], fov: 38 },
