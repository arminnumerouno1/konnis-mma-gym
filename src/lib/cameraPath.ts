...
export const CAMERA_KEYS: CamKey[] = [
  ...
  { t: 0.76, position: [0.0, 2.18, -70.8], target: [0, 5.5, -94], fov: 34 },
  { t: 0.815, position: [0.45, 2.42, -69.0], target: [0, 5.95, -94], fov: 32 },
...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.76, position: [0, 1.78, -68.2], target: [0, 4.55, -90], fov: 44 },
  { t: 0.82, position: [0, 2.02, -66.6], target: [0, 5.15, -90], fov: 42 },
