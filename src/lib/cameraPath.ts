...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.385, position: [0.02, 1.28, -32.5], target: [0.14, 0.92, -37.4], fov: 36 },
  { t: 0.414, position: [0.0, 1.08, -35.1], target: [0.16, 1.2, -38.4], fov: 31 },
  { t: 0.444, position: [0.0, 1.1, -35.35], target: [0.16, 1.18, -38.4], fov: 30 },
  { t: 0.474, position: [0.0, 1.32, -37.05], target: [0.06, 1.42, -43.6], fov: 34 },
