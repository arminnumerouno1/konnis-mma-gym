...
export const CAMERA_KEYS: CamKey[] = [
  ...
  { t: 0.76, position: [-0.8, 2.35, -75], target: [0.1, 3.65, -93], fov: 36 },
  { t: 0.825, position: [0.9, 2.7, -78.5], target: [0, 4.05, -95], fov: 34 },
...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.76, position: [0, 1.95, -73], target: [0, 3.55, -90], fov: 46 },
  { t: 0.82, position: [0, 2.2, -75.5], target: [0, 4.1, -90], fov: 44 },
