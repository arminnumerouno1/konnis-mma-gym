...
export const CAMERA_KEYS: CamKey[] = [
  ...
  { t: 0.76, position: [0.0, 2.02, -73.8], target: [0, 5.05, -94], fov: 36 },
  { t: 0.815, position: [0.35, 2.22, -71.6], target: [0, 5.45, -94], fov: 34 },
  { t: 0.858, position: [11.8, 4.8, -93.5], target: [0.6, 4.4, -102], fov: 36 },
...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.76, position: [0, 1.72, -70.4], target: [0, 4.35, -90], fov: 46 },
  { t: 0.82, position: [0, 1.92, -68.4], target: [0, 4.95, -90], fov: 44 },
  { t: 0.855, position: [0, 12.6, -84], target: [0, 5.3, -91], fov: 44 },
