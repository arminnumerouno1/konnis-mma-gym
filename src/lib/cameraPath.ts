...
export const CAMERA_KEYS: CamKey[] = [
  ...
  { t: 0.2, position: [0.55, 1.28, -8.8], target: [-3.15, 1.18, -17.45], fov: 34 },
  { t: 0.24, position: [0.2, 1.32, -10.6], target: [-2.9, 1.2, -17.65], fov: 34 },
...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.2, position: [0.35, 1.22, -10.8], target: [-3.05, 1.08, -17.55], fov: 36 },
  { t: 0.24, position: [0.2, 1.28, -12.2], target: [-2.85, 1.1, -17.7], fov: 36 },
