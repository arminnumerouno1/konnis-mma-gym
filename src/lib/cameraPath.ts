...
export const CAMERA_KEYS: CamKey[] = [
  ...
  { t: 0.7, position: [0.1, 2.15, -70.5], target: [0, 3.15, -90], fov: 38 },
  { t: 0.76, position: [-1.1, 2.55, -76], target: [0.15, 3.7, -93], fov: 36 },
  { t: 0.825, position: [1.2, 2.9, -79.5], target: [0, 4.1, -95], fov: 34 },
...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.7, position: [0, 1.65, -67.5], target: [0, 2.15, -78], fov: 40 },
  { t: 0.76, position: [0, 1.95, -73], target: [0, 3.45, -90], fov: 46 },
  { t: 0.82, position: [0, 2.2, -75.5], target: [0, 4.05, -90], fov: 44 },
