...
export const CAMERA_KEYS: CamKey[] = [
  ...
  { t: 0.2, position: [1.85, 1.52, -8.55], target: [-1.05, 0.82, -17.3], fov: 34 },
  { t: 0.24, position: [1.15, 1.55, -10.35], target: [-1.15, 0.76, -17.5], fov: 34 },
  { t: 0.29, position: [0.18, 1.42, -13.8], target: [0, 1.5, -24.2], fov: 35 },
...
export const CAMERA_KEYS_COMPACT: CamKey[] = [
  ...
  { t: 0.2, position: [0.06, 1.68, -6.55], target: [-1.05, 0.88, -17.35], fov: 44 },
  { t: 0.24, position: [0.04, 1.62, -8.15], target: [-1.1, 0.82, -17.45], fov: 42 },
  { t: 0.28, position: [0.08, 1.45, -14.8], target: [0, 1.45, -22], fov: 40 },
